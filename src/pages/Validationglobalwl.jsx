...
export default function Validationglobalwl() {
     const [records, setRecords] = useState([]);
     const [fullForm, setFullForm] = useState(false);
     const [searchCriteria, setSearchCriteria] = useState({
      Type: 'val', // Assuming this determines the table to query
    ...
    const fetchRecords = () => {
     axios.post('http://localhost:56478/api/Rithual', { type: "val4" })
         .then(response => {
