...
export default function Notificationglobal() {
     ...
     const [searchCriteria, setSearchCriteria] = useState({
          Type: 'global', // Assuming this determines the table to query
     ...
     const fetchRecords = () => {
          axios.post('http://localhost:56478/api/Rithual/notification', { type: "global" })
              .then(response => {
     ...
     const handleValidateClick = (record) => {
          const updateInfo = {
               ...
               Type: "global" // or "local" based on the context
     ...
     const submitUpdates = () => {
          ...
          axios.post('http://localhost:56478/api/Rithual/UpdateValidationsall', {
              Updates: updates,
              Type: "global" // Adjust based on your current context or make it dynamic
          })
          .then(response => {
     ...
     const generatePDF = async (record) => {
          const requestData = {
              NumeroTitreipp: record.nummarque_int,
              NumeroTitrecon: record.nummarque_c,
              type: 'global' // Assuming `type` is part of `record`
          };
