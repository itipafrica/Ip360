...
export default function NotificationManageglobalwl() {
     ...
     useEffect(() => {
          const fetchNotifications = async () => {
               setLoading(true);
               try {
                    const type = 'val4'; // This could be dynamically set based on user input or other logic
