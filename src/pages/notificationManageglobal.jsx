...
export default function NotificationManageglobal() {
     ...
     useEffect(() => {
          const fetchNotifications = async () => {
               setLoading(true);
               try {
                    const type = 'global'; // This could be dynamically set based on user input or other logic
