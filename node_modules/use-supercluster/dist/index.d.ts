...
declare const useSupercluster: <P extends GeoJsonProperties = Supercluster.AnyProps, C extends GeoJsonProperties = Supercluster.AnyProps>({ points, bounds, zoom, options, disableRefresh }: UseSuperclusterArgument<P, C>) => {
